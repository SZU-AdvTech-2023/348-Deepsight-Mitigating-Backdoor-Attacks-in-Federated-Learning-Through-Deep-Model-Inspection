...
if __name__ == '__main__':
    ...
    for epoch in range(args.epochs):
        ...
        #             users_idx = np.append(users_idx, (-1 * i))
        #     for i in range(1, args.num_attacker + 1):
        #         att = FlipsUpdate(args=args)
        #         loss = att.flips_ds(net=copy.deepcopy(global_model).to(args.device), num=(-1 * i))
        #         locals_loss.append(copy.deepcopy(loss))
        ...
        write_to_file(loss_avg, "ds_loss_NA")
        ...
        write_to_file(acc_test, "ds_acc_NA")
